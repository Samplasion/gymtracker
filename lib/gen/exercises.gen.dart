...
class GTStandardLibrary {
  static const cardio = $GTStandardLibraryCardioExercises._();
  ...
  static const shoulders = $GTStandardLibraryShouldersExercises._();
  static const back = $GTStandardLibraryBackExercises._();
...
class $GTStandardLibraryObliquesExercises {
  ...
  List<String> get values => [sidewaysPlank, sidewaysPlankReachThrough];
}
