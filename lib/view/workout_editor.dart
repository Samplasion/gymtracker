            ...
            IconButton(
              ...
              onPressed: () {
                showDialog(
                  context: context,
                  builder: (context) =>
                      WeightCalculator(weightUnit: workout.weightUnit),
                );
              },
            ),
            PopupMenuButton(
              ...
              itemBuilder: (context) => <PopupMenuEntry<dynamic>>[
                PopupMenuItem(
                  child: Text("historyEditor.actions.changeWeightUnit".t),
                  onTap: () {
                    setState(() {
                ...
                PopupMenuItem(
                  child: Text("historyEditor.actions.finish".t),
                  onTap: () {
  ...
  EditorCallbacks get callbacks => EditorCallbacks.editor(
      ...
      SchedulerBinding.instance.addPostFrameCallback((timeStamp) async {
        ...
        if (supersetIndex == null) {
          ...
          newExercises[supersetIndex] =
              (newExercises[supersetIndex] as Superset).copyWith(
                exercises: [
    ...
    onExerciseRemove: (index) {
      ...
      if (supersetIndex == null) {
        ...
        newExercises[supersetIndex] = superset.copyWith(
          exercises: [
                      ...
                      ex.exercises[j].copyWith(
                        sets: [
                          for (int k = 0; k < ex.exercises[j].sets.length; k++)
                            if (k == setIndex)
                              ex.exercises[j].sets[k].copyWith(rpe: value)
                            else
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  TweenAnimationBuilder(
                    tween: Tween<double>(begin: 0, end: reps.toDouble()),
              ...
              Column(
                ...
                children: [
                  ...
                  TweenAnimationBuilder(
                    tween: Tween<double>(begin: 0, end: liftedWeight),
                    curve: Curves.decelerate,
                    duration: const Duration(milliseconds: 400),
                    builder: (context, value, _) {
...
class WorkoutFinishEditingPage extends StatefulWidget {
  ...
  const WorkoutFinishEditingPage({super.key, required this.workout});
                        ...
                        if (!widget.workout.isContinuation)
                          TextFormField(
                            ...
                            decoration: _decoration(
                              "historyEditor.finish.fields.name.label".t,
                            ),
                            validator: (string) {
